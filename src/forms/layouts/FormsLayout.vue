<template>
  <div class="space-y-6 h-screen">
    ...
    <div class="flex flex-col space-y-8 lg:flex-row lg:space-x-12 lg:space-y-0 h-full">
      <aside class=" flex h-full max-h-screen flex-col gap-2 w-64 pt-12 rounded-tl-none rounded-tr-[50px] rounded-b-none rounded-l-none">
        <SidebarNav />
      </aside>
